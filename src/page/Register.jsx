      ...
      <div className="flex w-full max-w-[1200px] min-h-[800px] bg-white shadow-2xl rounded-3xl overflow-hidden m-4">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-lg text-gray-200">Join thousands of users finding their dream homes.</p>
          </div>
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-16 flex flex-col justify-center">
          ...
          <p className="text-center text-gray-500 mt-8">
            Already have an account? <a href="/login" className="text-red-600 font-bold hover:underline">Login</a>
          </p>
        </div>
      </div>
    </div>
